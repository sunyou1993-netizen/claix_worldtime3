...
export interface CityClockData {
  city: City;
  timeString: string;
  dateString: string;
  isNight: boolean;
...
let cityNotes: Record<string, string> = {};
let selectedCity: City | null = null;
let isFrameMode = true;

// 3. UI Element References
const toggleFrameBtn = document.getElementById("toggle_frame_btn") as HTMLButtonElement | null;
const phoneMockup = document.getElementById("phone_mockup") as HTMLDivElement | null;
const resetBtn = document.getElementById("reset_btn") as HTMLButtonElement | null;
const closeBtn = document.getElementById("close_btn") as HTMLButtonElement | null;
const searchForm = document.getElementById("search_form") as HTMLFormElement | null;
const searchInput = document.getElementById("search_input") as HTMLInputElement | null;
const suggestionsDropdown = document.getElementById("suggestions_dropdown") as HTMLDivElement | null;
const suggestionsBackdrop = document.getElementById("suggestions_backdrop") as HTMLDivElement | null;
const suggestionsList = document.getElementById("suggestions_list") as HTMLDivElement | null;
const clockGrid = document.getElementById("clock_grid") as HTMLDivElement | null;

// Modal elements
const modalBackdrop = document.getElementById("modal_backdrop") as HTMLDivElement | null;
const detailModal = document.getElementById("detail_modal") as HTMLDivElement | null;
const modalCloseHandle = document.getElementById("modal_close_handle") as HTMLDivElement | null;
const modalCloseBtn = document.getElementById("modal_close_btn") as HTMLButtonElement | null;
const modalFlag = document.getElementById("modal_flag") as HTMLSpanElement | null;
const modalCountryEn = document.getElementById("modal_country_en") as HTMLDivElement | null;
const modalTitle = document.getElementById("modal_title") as HTMLHeadingElement | null;
const modalDate = document.getElementById("modal_date") as HTMLSpanElement | null;
const modalUtcOffset = document.getElementById("modal_utc_offset") as HTMLSpanElement | null;
const modalTime = document.getElementById("modal_time") as HTMLHeadingElement | null;
const modalStatusBadge = document.getElementById("modal_status_badge") as HTMLSpanElement | null;
const modalTimelineBar = document.getElementById("modal_timeline_bar") as HTMLDivElement | null;
const modalMeetingBadge = document.getElementById("modal_meeting_badge") as HTMLDivElement | null;
const modalMeetingDesc = document.getElementById("modal_meeting_desc") as HTMLParagraphElement | null;
const modalTimeDiffBadge = document.getElementById("modal_time_diff_badge") as HTMLSpanElement | null;
const modalSeoulTime = document.getElementById("modal_seoul_time") as HTMLSpanElement | null;
const modalTargetLabel = document.getElementById("modal_target_label") as HTMLSpanElement | null;
const modalTargetTime = document.getElementById("modal_target_time") as HTMLSpanElement | null;
const modalNotepad = document.getElementById("modal_notepad") as HTMLTextAreaElement | null;
const modalNotepadSaveBtn = document.getElementById("modal_notepad_save_btn") as HTMLButtonElement | null;

// Add City Modal elements
const addCityModalBackdrop = document.getElementById("add_city_modal_backdrop") as HTMLDivElement | null;
const addCityModal = document.getElementById("add_city_modal") as HTMLDivElement | null;
const addCityModalCloseBtn = document.getElementById("add_city_modal_close_btn") as HTMLButtonElement | null;
const addCityModalSearch = document.getElementById("add_city_modal_search") as HTMLInputElement | null;
const addCityModalList = document.getElementById("add_city_modal_list") as HTMLDivElement | null;
const addCityModalSuggestions = document.getElementById("add_city_modal_suggestions") as HTMLDivElement | null;
const addCityModalSuggestionsList = document.getElementById("add_city_modal_suggestions_list") as HTMLUListElement | null;
...
function getRawUtcOffset(timezone: string, baseTime: Date): string {
  try {
...
function getCityClockData(city: City, baseTime: Date): CityClockData {
  try {
...
function getMeetingStatus(timeString: string) {
...
function renderGrid() {
  ...
  activeCities.forEach((city) => {
    ...
    card.innerHTML = `
      ...
      >
        <svg class="w-7 h-7 stroke-[2.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
      </button>
    `;
...
function showToast(toastEl: HTMLDivElement | null) {
  if (!toastEl) return;
...
function getCityXY(city: City): { x: number; y: number } {
...
function getCityLatLng(city: City): [number, number] {
...
async function updateFreeMap(city: City) {
...
function openDetailModal(city: City) {
  selectedCity = city;
  const baseTime = new Date();
  const data = getCityClockData(city, baseTime);
...
function renderAddCityModalList() {
  ...
  const groups: { [key: string]: { countryCode: string, cities: City[] } } = {};
...
function setupEventListeners() {
  ...
  if (closeBtn) {
    closeBtn.onclick = (window as any).handleCloseBtnClick;
  }
